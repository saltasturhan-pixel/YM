...
export function buildData() {
  ...
  sirali.forEach((ilan, i) => {
    ...
    // Görüntüleyicinin ilk ekranındaki özet/rapor (idareye sorulacak hususlar,
    // can alıcı noktalar, YM'de dikkat/eksikler). Belgelerden üretilir.
    ilan.rapor = ic.rapor || null;
  });
