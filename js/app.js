  ...
  function render() {
    ...
    listEl.innerHTML = visible.map(ilan => `
      <article class="ilan-card">
        ...
        <div class="ilan-sag">
          ${ilan.tutar != null ? `<span class="ilan-tutar${(ilan.paraBirimi === "USD" || ilan.paraBirimi === "EUR") ? " doviz" : ""}">${formatTutar(ilan.tutar)} <small>${escapeHtml(ilan.paraBirimi || "TL")}</small></span>` : ""}
